...
export default function Select({ label, error, options = [], style: extraStyle = {}, ...props }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
      ...
      <select
        style={{ ...fieldStyle, borderColor: error ? 'rgba(244,63,94,0.6)' : 'rgba(255,255,255,0.12)', ...extraStyle }}
